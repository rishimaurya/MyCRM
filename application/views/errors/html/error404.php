...
<html>
  <head>
    ...
    <script src="<?php echo base_url('assets/error/jquery.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/error/jquery-ui.min.js'); ?>"></script>
    <link rel="stylesheet" media="screen" href="<?php echo base_url('assets/error/fwasome.css'); ?>" />
    <link rel="stylesheet" media="screen" href="<?php echo base_url('assets/error/gff.css'); ?>" />
...
<div class="text-container">
	...
	<div class="buttons-container">
		<a class="border-button" href="<?php echo base_url();?>" target="_blank"><span class="fa fa-home"></span> Home Page</a>
		<a class="border-button" href="mailto:me@rishimaurya.in" target="_blank"><span class="fa fa-warning"></span> Report Problem</a>
	</div>
</div>
  ...
  <script src="<?php echo base_url('assets/error/co2.js'); ?>" type="text/javascript" charset="UTF-8"></script>
