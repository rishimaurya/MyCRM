...
<div class="myjumbo">
  ...
  <div class="form-group">  
      ...
      <div class="col-sm-2">
         <input type="text" name="first_name" class="form-control" value="<?php if(!empty($mydata)) echo $mydata[0]->first_name;?>" readonly required> 
      </div>
	  <div class="col-sm-2">
        <input type="text" name="middle_name" class="form-control" value="<?php if(!empty($mydata)) echo $mydata[0]->middle_name;?>"readonly required >
      </div>
	  <div class="col-sm-2">
        <input type="text" name="last_name" class="form-control" value="<?php if(!empty($mydata)) echo $mydata[0]->last_name;?>"readonly required >
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">          
        <input type="email" name="email" class="form-control" value="<?php if(!empty($mydata)) echo $mydata[0]->email;?>"readonly required >
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-4 ">Next Follow Up Date</label>
      <div class="col-sm-6">          
        <input type="date" name="follow_up_date" class="form-control" value="<?php if(!empty($mydata)) echo $mydata[0]->follow_up_date;?>" readonly required >
      </div>
    </div>
    <div class="form-group">
   ...
   -->
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">          
        <input type="text" name="service_amount" id="subpost" class="form-control" value="<?php echo $mydata[0]->service_amount;?>"readonly required>
      </div>
    </div>
      ...
      <div class="col-sm-3">          
        <input type="text" name="discount" class="form-control" placeholder="Discount" value="<?php  echo $mydata[0]->discount;?>"  readonly required>
      </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-3">          
        <input type="text" name="discount" class="form-control"  value="<?php  echo $mydata[0]->total_amount;?>"  readonly required>
      </div>
    </div>
      ...
      <div class="col-sm-3">          
        <select type="date" name="mode" class="form-control">
		     ...
		     <option <?php if(strcasecmp($mydata[0]->status,"debitcard")==0){ echo "selected" ;} ?> value="debitcard">Debit Card</option>
		     <option <?php if(strcasecmp($mydata[0]->status,"creditcard")==0){ echo "selected" ;} ?> value="creditcard">Credit Card</option>
		     <option <?php if(strcasecmp($mydata[0]->status,"netbanking")==0){ echo "selected" ;} ?> value="netbanking">Net Banking</option>
		     <option <?php if(strcasecmp($mydata[0]->status,"wallet")==0){ echo "selected" ;} ?> value="wallet">Wallets</option>		     
		</select>	
      </div>
    </div>
<div class="form-group">
      ...
      <div class="col-sm-3">          
        <input type="date" name="date" class="form-control" value="<?php echo $mydata[0]->date; ?>"   readonly required>
      </div>
    </div>
<div class="form-group">
