...
function updateClock (){
	...
	<body class="no-skin" style="min-height:850px">
					...
					<!--	<li class="grey dropdown-modal">
						...
						<li class="light-blue dropdown-modal">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li data-toggle="modal" data-target="#logout" style="list-style-type: none;">
									<a href="#">
		...
		<div class="main-container ace-save-state" id="main-container">
         ...
         <span style="display:inline;color:black;font-weight: bold;"><?php echo date("Y-m-d") ; ?></span> <span id="clock" style="padding-left:5px;color:black;font-weight: bold;"></span>
				...
				<!--	<li class="">
					...
					<li class="">
						<a href="<?php echo base_url('Admin/fullChat');?>">
							<i class="menu-icon fa fa-print"></i>
							<span class="menu-text"> Full Chat </span>
						</a>
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo base_url('Leads/approve_sell_order');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Approve Sales Order
								</a>
								<b class="arrow"></b>
							...
							<li class="">
								<a href="<?php echo base_url('Leads/freetrail');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Approve Free Trail
								</a>
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa fa-check"></i>
							<span class="menu-text"> Blocking </span>
							<b class="arrow fa fa-angle-down"></b>
						</a>
						<b class="arrow"></b>
						<ul class="submenu">
							<li class="">
								<a href="<?php echo base_url('Admin/blockingusers');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Block Users
								</a>
								<b class="arrow"></b>
							...
							<li class="">
								<a href="<?php echo base_url('Login/blockTempCrm');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Block CRM
								</a>
							...
							<li class="">
								<a href="<?php echo base_url('Login/unBlockTempCrm');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Un-Block CRM
								</a>
...
<!--					<li class="">
	...
	-->			  <li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo base_url('Admin/addBank');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Add Bank Details
								</a>
								<b class="arrow"></b>
							...
							<li class="">
								<a href="<?php echo base_url('Admin/updateBank');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Update Bank Details
								</a>
								<b class="arrow"></b>
							...
							<li class="">
								<a href="<?php echo base_url('Admin/generalDetails');?>">
									<i class="menu-icon fa fa-caret-right"></i>
    ...
    <div class="modal-dialog">
	  ...
	  <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="wrapper">
            <span class="group-btn col-sm-6" >     
               <form name="edit" class="form-horizontal" action="<?php echo base_url().'Login/logout'; ?>"  method="POST"> 
                  <input type="submit" name="submit" class="btn btn-primary  btn-edit" value="LogOut"></form>
            </span>
             <span class="group-btn col-sm-6"> 
                  <form name="edit" class="form-horizontal" action="<?php echo base_url().'Login/blockLogout'; ?>"  method="POST">    
                <input type="submit" name="submit" class="btn btn-danger  btn-edit" value="Block CRM And LogOut"></form>
            </span>
            </div>
            </div>
			</div>
