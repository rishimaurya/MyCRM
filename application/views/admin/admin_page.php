											...
											<a href="#" class="clearfix" style="text-decoration:none !important;>
												...
												<!--<span class="msg-body">
													<span class="msg-title">-->
														<span class="blue" style="font-weight: bold;color:#2C6AA0 !important;"><?php echo $m['0']->sender_name; ?></span><span class="msg-time">
									 ...
									 <?php if(!empty($msg))foreach($msg as $m) {?>
										<li style="list-style-type: none;">
											<a href="#" class="clearfix" style="text-decoration:none !important;>
												...
												<!--<span class="msg-body">
													<span class="msg-title">-->
														<span class="blue" style="font-weight: bold;color:#2C6AA0 !important;"><?php echo $m->sender_name; ?></span><span class="msg-time">
														<i class="ace-icon fa fa-clock-o"></i>
