...
<div class="myjumbo" >
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">          
        <input type="date" name="dob" class="form-control" placeholder="yyyy-mm-dd" value="<?php $row=$this->session->userdata('my_session');echo $row['dob'];?>" >
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">          
        <input type="text" name="fname" class="form-control" placeholder=" father's name" value="<?php $row=$this->session->userdata('my_session');echo $row['father_name'];?>" >
      </div>
    </div>
    <div class="form-group">
